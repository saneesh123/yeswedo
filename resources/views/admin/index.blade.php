            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li><a  href="dashboard-events"><i class="notika-icon notika-edit"></i> Events</a>
                        </li>
                        <li><a  href="dashboard-job"><i class="notika-icon notika-mail"></i> Job Portal</a>
                        </li>
                        <li><a  href="dashboard-realestate"><i class="notika-icon notika-mail"></i> Real Estate</a>
                        </li>
                        <li><a  href="dashboard-services"><i class="notika-icon notika-mail"></i> Other Service</a>
                        </li>
                    </ul>
