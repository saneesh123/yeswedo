            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <li class="active"><a href="dashboard"><i class="notika-icon notika-house"></i> Home</a>
                        </li>
                        <li><a  href="gallery"><i class="notika-icon notika-edit"></i> Job Category</a>
                        </li>
                        <li><a  href="email-manager"><i class="notika-icon notika-mail"></i> Jobs</a>
                        </li>
                        <li><a  href="email-manager"><i class="notika-icon notika-mail"></i>Registered Users</a>
                        </li>
                        <li><a  href="email-manager"><i class="notika-icon notika-mail"></i>Registered Company</a>
                        </li>
                        <li><a  href="email-manager"><i class="notika-icon notika-mail"></i>Email manager</a>
                        </li>
