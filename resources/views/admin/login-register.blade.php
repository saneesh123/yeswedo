        ...
        <div class="nk-block toggled" id="l-login">
              <div class="nk-form">
                  <div class="input-group">
                      ...
                      <div class="nk-int-st">
                          <input type="text"  name="txtName" id="txtName" class="form-control" placeholder="Username">
                      </div>
                  </div>
                ...
                <button class="btn btn-success .notika-btn-green   waves-effect pull-right" onclick="javascript: jsSubmit()" >Login</button>
                </div>
        ...
        <div class="nk-block" id="l-register">
            <div class="nk-form">
                ...
                <div class="input-group mg-t-15">
                    ...
                    <div class="nk-int-st">
                        <input type="text" name="txtEmail" id="txtEmail" class="form-control" placeholder="Email Address">
                    </div>
                </div>
